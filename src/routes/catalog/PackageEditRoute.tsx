  ...
  if (isLoading) {
    return (
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        <div className="h-72 animate-pulse rounded-xl border border-border bg-surface-muted/60" />
      </div>
    );
  }
  ...
  if (error || !pkg) {
    return (
      ...
      >
        ...
        <h3 className="text-base font-semibold text-text-primary">Package not found</h3>
        <button
          type="button"
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="flex items-center gap-3 border-b border-border-subtle pb-5">
        ...
        <div>
          <h1 className="text-xl font-semibold tracking-tight text-text-primary">Edit Package</h1>
