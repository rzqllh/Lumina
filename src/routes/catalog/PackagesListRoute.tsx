...
import { Plus, Search, Package, Sparkles, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-text-primary">Packages Catalog</h1>
        ...
        <div className="flex items-center gap-1 rounded-xl border border-border bg-surface p-1 self-start sm:self-auto">
          {[
            ...
            <button
              key={tab.id}
              type="button"
              data-testid={`filter-${tab.id}-packages`}
      ...
      {isLoading ? (
        ...
        >
          ...
          <h3 className="text-sm font-bold text-text-primary">Failed to load packages</h3>
        ...
        >
          ...
          <h3 className="text-base font-bold text-text-primary">
            {searchQuery ? 'No matching packages found' : 'No packages in catalog yet'}
          </h3>
