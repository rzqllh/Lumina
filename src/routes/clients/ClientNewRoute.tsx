  ...
  return (
    <div className="mx-auto max-w-xl space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tight text-text-primary">Create New Client</h1>
          <p className="text-xs text-text-secondary">Add a client profile to your workspace.</p>
        </div>
      </div>
