            ...
            events.map((event) => {
              ...
              return (
                <div
                  ...
                  className="group flex flex-col justify-between rounded-xl border border-border bg-surface p-3.5 shadow-2xs hover:border-border-subtle hover:bg-surface-muted/30 transition-all cursor-pointer space-y-2"
                >
                  <div className="flex items-start justify-between gap-2">
                    <span
                      className={`inline-flex items-center rounded-md border px-2 py-0.5 text-[10px] font-bold ${badge.style}`}
                    >
                      {badge.label}
                    </span>
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-text-muted font-medium">{event.projectTitle}</p>
                  </div>
