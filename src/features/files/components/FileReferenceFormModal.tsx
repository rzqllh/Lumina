        ...
        <div className="flex items-center justify-between border-b border-border pb-3">
          <div>
            <h2 className="text-base font-semibold text-text-primary flex items-center gap-2">
              <Link2 className="h-4 w-4 text-primary-text" strokeWidth={1.75} />
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-border bg-surface px-3 py-2 text-xs text-text-primary placeholder:text-text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            />
            {errors.display_name && (
              <p className="text-xs text-status-danger-text mt-1">{errors.display_name.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.url_or_path && (
              <p className="text-xs text-status-danger-text mt-1">{errors.url_or_path.message}</p>
            )}
          </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-3 border-t border-border">
            <button
              type="button"
              onClick={onClose}
              className="rounded-lg border border-border px-4 py-2 text-xs font-semibold text-text-secondary hover:bg-surface-muted transition-colors cursor-pointer"
            >
              Cancel
            </button>
            <button
