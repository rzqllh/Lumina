...
export const ContactFormModal: React.FC<ContactFormModalProps> = ({
  ...
  return (
    ...
    >
      <div className="w-full max-w-md rounded-2xl border border-border bg-surface p-6 shadow-lg sm:p-7">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-border-subtle pb-4">
          <h2 id="contact-modal-title" className="text-base font-bold text-text-primary">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              {...register('name')}
              className={`w-full rounded-xl border bg-surface px-3.5 py-2 text-sm text-text-primary placeholder:text-text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring transition-colors ${
          ...
          <div>
            ...
            <input
              ...
              {...register('role_label')}
              className="w-full rounded-xl border border-border bg-surface px-3.5 py-2 text-sm text-text-primary placeholder:text-text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-2.5 pt-4 border-t border-border-subtle">
            ...
            <button
              ...
              className="flex cursor-pointer items-center justify-center gap-2 rounded-xl bg-primary px-4 py-2 text-xs font-semibold text-primary-foreground transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-60"
            >
              {isSubmitting ? (
                <>
