...
SELECT tests.create_supabase_user('portal_owner@lumina.app');
SELECT tests.authenticate_as('portal_owner@lumina.app');

INSERT INTO public.workspaces (id, name, owner_id)
VALUES ('11111111-1111-1111-1111-111111111111', 'Portal Test Studio', tests.get_supabase_uid('portal_owner@lumina.app'));

INSERT INTO public.workspace_members (workspace_id, user_id, role)
VALUES ('11111111-1111-1111-1111-111111111111', tests.get_supabase_uid('portal_owner@lumina.app'), 'owner');
...
INSERT INTO public.expenses (workspace_id, project_id, category, amount, description)
VALUES ('11111111-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', 'gear_rental', 2500000, 'Tilt-shift lens rental');
